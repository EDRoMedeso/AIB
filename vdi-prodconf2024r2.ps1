...
ANSYS 2022R2, 2023R1, 2023R2, 2024R1 and 2024R2
Love Håkansson 2023-09-13, 2023-10-10, 2024-01-20, 2024-09-10
#>
...
Start-Process -FilePath "\\spark\ansys inc\v242\ProductConfig.exe" -ArgumentList @('-silent', '-prereqs') -Wait
Start-Process -FilePath "\\spark\ansys inc\v242\ProductConfig.exe" -ArgumentList @('-silent', '-caspol') -Wait
